// Define actions for each context menu option
const ACTIONS = {
...
// This will run when the extension is first installed
                ...
                chrome.tabs.group({
                    ...
                    chrome.tabGroups.update(groupId, { title: domain }, function (updatedGroup) {
                        if (chrome.runtime.lastError) {
                            ...
                            console.log(`Tab group with ID ${updatedGroup.id} updated with title: ${updatedGroup.title}`);
                        }
                    });
                });
            }
...
function getTopLevelDomain(hostname) {
    ...
    if (parts != null && parts.length > 1) {
        ...
        if (secondLevelDomain === 'co' || secondLevelDomain === 'com' || secondLevelDomain === 'gov' || secondLevelDomain === 'edu' || secondLevelDomain === 'ac') {
